    ...
    <main className="min-h-screen bg-white">
      <div className="w-full my-0 px-0 py-[10px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch w-full">
          {/* Left side - Image */}
          <div className="relative flex h-full transition-transform pl-[10px] pr-[10px] lg:pr-0">
            <Image
              src="/1.png"
          ...
          {/* Right side - Content */}
          <div className={`space-y-5 lg:space-y-6 xl:space-y-8 flex flex-col h-full justify-start pl-[10px] pr-[10px] lg:pl-0 lg:pr-0 ${showForm ? "pt-0 lg:pt-0" : "pt-10"}`}>
            {!showForm && (
              <>
                <h1 className="text-2xl lg:text-[26px] xl:text-[28px] font-bold leading-tight">
                Master Your Cybersecurity 
                  <br />
                  Strategy with the
                   <span className="text-[#C4342B]"> Right SIEM 
                    <br />
                    Solution</span>
                </h1>
            ...
            {showForm && (
              <Card className="w-full h-auto -mt-[40px] lg:mt-[55px] mb-[10px] border border-gray-200 shadow-md flex flex-col">
